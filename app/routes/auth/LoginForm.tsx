      ...
      <Card className="relative backdrop-blur-xl bg-transparent border border-white/20 shadow-xl rounded-lg">
        <CardBody className="p-6">
          ...
          <div className="flex flex-col items-center mb-6">
            <Avatar
              className="w-16 h-16 mb-3 ring-2 ring-white/30 shadow-lg bg-gradient-to-br from-blue-500 to-purple-600"
              fallback={
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2 bg-white/80 backdrop-blur-sm border-2 border-white/30 rounded-lg p-3 shadow-md hover:shadow-lg hover:bg-white/90 focus-within:bg-white/95 focus-within:border-blue-500/50 transition-all duration-300 ease-in-out">
                <div className="flex items-center justify-center w-4 h-4 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex-shrink-0">
                  <svg
                    className="w-2.5 h-2.5 text-white"
                    fill="currentColor"
                    viewBox="0 0 20 20"
            ...
            <Button
              ...
              isLoading={isLoading}
              disabled={isLoading}
              className="w-full relative overflow-hidden rounded-lg bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white font-medium shadow-lg hover:shadow-xl transform transition-all duration-300 hover:-translate-y-0.5"
            >
