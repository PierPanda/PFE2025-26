  ...
  return (
    <div className="flex items-center justify-center gap-4 px-8 pb-8 bg-tertiary">
      <Pagination
        ...
        radius="md"
        classNames={{
          item: 'bg-secondary text-tertiary hover:!bg-primary hover:!text-dark data-[hovered=true]:!bg-primary data-[hovered=true]:!text-dark data-[pressed=true]:!bg-primary data-[pressed=true]:!text-dark',
