// better-auth schema
export { user, session, account, verification } from './schema-definition/auth-schema';
...
// relations
export { userRelations, sessionRelations, accountRelations } from './schema-definition/auth-relations';
