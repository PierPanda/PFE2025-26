 ...
 */
export async function deleteTeacher(teacherId: string): Promise<DeleteTeacherResponse> {
  try {
    ...
    return {
      success: false,
      error: "Une erreur s'est produite lors de la suppression de l'enseignant.",
    };
  }
}
